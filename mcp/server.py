...
def _birth_payload(name, year, month, day, hour, minute, lat, lon, tz, house_system="PLACIDUS", zodiac="TROPICAL", ayanamsa="LAHIRI"):
    return {
        "birth_data": {
        ...
        "options": {"house_system": house_system, "zodiac_type": zodiac, "ayanamsa": ayanamsa},
    }
...
async def get_natal_chart(name: str, birth_year: int, birth_month: int, birth_day: int,
                          ...
                          zodiac_type: str = "TROPICAL", ayanamsa: str = "LAHIRI") -> dict:
    ...
    return await _post("/natal/chart", _birth_payload(name, birth_year, birth_month, birth_day,
                       birth_hour, birth_minute, latitude, longitude, timezone, house_system, zodiac_type, ayanamsa))
...
async def get_solar_return(name: str, birth_year: int, birth_month: int, birth_day: int,
    ...
    return await _post("/progressions/solar-return", payload)
